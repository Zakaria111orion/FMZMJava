        ...
        switch (order) {
            ...
            case Left:
                if(this.direction == MobileOrder.Left &&
                        this.pos.y > 0 &&
                        tileMap[this.pos.x][this.pos.y - 1].getPermeability() == true && !tileMap[this.pos.x][this.pos.y - 1].getClass().getSimpleName().contains("Bone") )
                {
                ...
                } else { if(tileMap[this.pos.x][this.pos.y - 1].getPermeability() == true  && !tileMap[this.pos.x][this.pos.y - 1].getClass().getSimpleName().contains("Bone")) {
                	this.pos.setLocation(
                            this.pos.getX(),
                            this.pos.getY() - 1);
                    this.image = Element.loadSprite("lorann_l.png");
            ...
            case Up:
                if(this.direction == MobileOrder.Up &&
                        this.pos.x > 0 &&
                        tileMap[this.pos.x - 1][this.pos.y].getPermeability() == true && !tileMap[this.pos.x - 1][this.pos.y].getClass().getSimpleName().contains("Bone")) {
                    this.pos.setLocation(
                            this.pos.getX() - 1,
                            this.pos.getY());
                } else {
                	if(tileMap[this.pos.x - 1][this.pos.y].getPermeability() == true && !tileMap[this.pos.x - 1][this.pos.y].getClass().getSimpleName().contains("Bone")){
                        this.pos.setLocation(
                                this.pos.getX() - 1,
                                this.pos.getY());
